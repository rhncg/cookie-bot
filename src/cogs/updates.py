...
class Updates(discord.Cog):
    ...
    async def updates(self, ctx):
        ...
        embed.add_field(name="Version", value="2.2.4", inline=False)
        embed.add_field(name="Completed (in order of completion)", value="- Buffed Idle Upgrade (higher rate now)\n"
                                                ...
                                                "- Drops\n"
                                                "- You can now right click a user and go to \"Apps\" to steal from them or view their profile.", inline=False)
